...
public:
     ...
     * @param parent 父对象
     */
    explicit DataSynchronizer(int syncIntervalMs = Core::DEFAULT_SYNC_INTERVAL_MS, QObject *parent = nullptr);
...
private:
     ...
     * @return 同步数据帧
     */
    Core::SynchronizedDataFrame createSyncFrame() const;
